...
vtkPlusIntuitiveDaVinciTrackerXi::vtkPlusIntuitiveDaVinciTrackerXi()
  ...
  , DebugSineWaveMode(false)
	...
	, usm1Frame1(NULL), usm1Frame2(NULL), usm1Frame3(NULL), usm1Frame4(NULL), usm1Frame5(NULL), usm1Frame6(NULL), usm1Frame7(NULL), usm1Frame8(NULL), usm1Frame9(NULL), usm1Frame10(NULL)
	, usm2Frame1(NULL), usm2Frame2(NULL), usm2Frame3(NULL), usm2Frame4(NULL), usm2Frame5(NULL), usm2Frame6(NULL), usm2Frame7(NULL), usm2Frame8(NULL), usm2Frame9(NULL), usm2Frame10(NULL)
	, usm3Frame1(NULL), usm3Frame2(NULL), usm3Frame3(NULL), usm3Frame4(NULL), usm3Frame5(NULL), usm3Frame6(NULL), usm3Frame7(NULL), usm3Frame8(NULL), usm3Frame9(NULL), usm3Frame10(NULL)
	, usm4Frame1(NULL), usm4Frame2(NULL), usm4Frame3(NULL), usm4Frame4(NULL), usm4Frame5(NULL), usm4Frame6(NULL), usm4Frame7(NULL), usm4Frame8(NULL), usm4Frame9(NULL), usm4Frame10(NULL)
{
...
PlusStatus vtkPlusIntuitiveDaVinciTrackerXi::InternalConnect()
{
  ...
  GetToolByPortName("usm1Frame7",  this->usm1Frame7);
	...
	GetToolByPortName("usm1Frame10", this->usm1Frame10);
  ...
  GetToolByPortName("usm2Frame7",  this->usm2Frame7);
	...
	GetToolByPortName("usm2Frame10", this->usm2Frame10);
	...
	GetToolByPortName("usm3Frame10", this->usm3Frame10);
	...
	GetToolByPortName("usm4Frame10", this->usm4Frame10);
...
PlusStatus vtkPlusIntuitiveDaVinciTrackerXi::InternalUpdate()
{
  ...
  tmpVtkMatrix->SetElement(1, 2, jointValues[6]);
	...
	tmpVtkMatrix->SetElement(2, 1, jointValues[9]);
  ...
  ISI_TRANSFORM* usm1Transforms = this->DaVinci->GetUsm1()->GetTransforms();
	...
	PUBLISH_ISI_TRANSFORM(usm1Frame10, usm1Transforms + 9);
  ...
  // Update all of the usm2Frames
	...
	PUBLISH_ISI_TRANSFORM(usm2Frame10, usm2Transforms + 9);
	...
	PUBLISH_ISI_TRANSFORM(usm3Frame10, usm3Transforms + 9);
	...
	PUBLISH_ISI_TRANSFORM(usm4Frame10, usm4Transforms + 9);
...
static void ConvertTokenVectorToDhTable(std::vector<std::string>& srcTokenVector, ISI_DH_ROW* destIsiDhTable)
{
	...
	for (int iii = 0; iii < mNumDhRows; iii++)
  {
    try
    {
			...
			destIsiDhTable[iii].type = (ISI_FLOAT)std::stof(srcTokenVector[mNumDhCols * iii + 0]);
			destIsiDhTable[iii].l = (ISI_FLOAT)std::stof(srcTokenVector[mNumDhCols * iii + 1]);
			destIsiDhTable[iii].sina = (ISI_FLOAT)std::stof(srcTokenVector[mNumDhCols * iii + 2]);
			destIsiDhTable[iii].cosa = (ISI_FLOAT)std::stof(srcTokenVector[mNumDhCols * iii + 3]);
			destIsiDhTable[iii].d = (ISI_FLOAT)std::stof(srcTokenVector[mNumDhCols * iii + 4]);
			destIsiDhTable[iii].sinq = (ISI_FLOAT)std::stof(srcTokenVector[mNumDhCols * iii + 5]);
			destIsiDhTable[iii].cosq = (ISI_FLOAT)std::stof(srcTokenVector[mNumDhCols * iii + 6]);
    }
    catch (...)
    {
																																		...
																																		std::string usm3DhTable,std::string usm4DhTable)
{
	...
	const int numDhRows = 10; const int numDhCols = 7;
